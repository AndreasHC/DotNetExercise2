...
namespace DotNetExercise2
{
    ...
    {
        public static Dictionary<string, int> prices = new Dictionary<string, int> { { "Gratis", 0 }, { "Ungdomspris", 80 }, { "Pensionärspris", 90 }, { "Standardpris", 120 } };

        public static IntegerInputRequest ageRequest = new IntegerInputRequest("Ange kundens ålder: ", "Kundens ålder måste anges i hela år, uttryckta med siffror, och måste vara 0-300.", 0, 300);
